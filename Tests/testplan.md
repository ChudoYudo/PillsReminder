...
| ---------------------------------------- | :------: | :------------------------------: |
| Функция добавления лекарственного средства | 001 | |
| Функция удаления лекарственного средства | 002 |   |
| Функция входа в аккаунт пользователя | 003 |   |
| Функция регистрации нового аккаунта | 004 |   |

| Атрибуты качества              | ID теста | Успешность прохождения тестов, % |
| ---------------------------------------- | :------: | :------------------------------: |
| Возможность использования единого аккаунта для различных iOS устройств | 005 |   |
